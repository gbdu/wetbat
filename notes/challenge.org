...
Some forms are doing validation manually, like CreateOrEditQuote.js,
others are using React Form Hooks, like for for the contact form
creation. 
...
phpmyadmin image to test again.
